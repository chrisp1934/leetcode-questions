...
int *twoSum(int *nums, int numsSize, int target, int *returnSize)
{
    ...
    {
        int first_addend = nums[index_of_first_addend];
        ...
        {
            int index_of_second_addend = (hash_item_node->data).index;
        ...
        else if (insert_key_in_hash_table(hash_table, hash_table_size, first_addend, index_of_first_addend) == EXIT_FAILURE)
        {
            free_hash_table(hash_table, hash_table_size);
            return (NULL);
        }
